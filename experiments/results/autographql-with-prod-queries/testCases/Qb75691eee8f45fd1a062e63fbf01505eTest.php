...
class Qb75691eee8f45fd1a062e63fbf01505eTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment CategoryTranslationFragment on Category {\n  id\n  name\n  descriptionJson\n  seoDescription\n  seoTitle\n  translation(languageCode: $language) {\n    id\n    descriptionJson\n    language {\n      language\n      __typename\n    }\n    name\n    seoDescription\n    seoTitle\n    __typename\n  }\n  __typename\n}\n\nquery CategoryTranslationDetails($id: ID!, $language: LanguageCodeEnum!) {\n  category(id: $id) {\n    ...CategoryTranslationFragment\n    __typename\n  }\n}\n", "variables": {"id": "Q2F0ZWdvcnk6Nw==", "language": "EN"}, "operationName": "CategoryTranslationDetails", "timesCalled": 2, "createdAt": "2021-09-04 19:57:24.068257+00:00", "updatedAt": "2021-09-04 20:28:59.338275+00:00"}
JSON;
