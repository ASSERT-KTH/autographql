...
class Q904f8f3413fb5b1486b71f03b1fb0642Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment PageInfoFragment on PageInfo {\n  endCursor\n  hasNextPage\n  hasPreviousPage\n  startCursor\n  __typename\n}\n\nquery SearchCustomers($after: String, $first: Int!, $query: String!) {\n  search: customers(after: $after, first: $first, filter: {search: $query}) {\n    edges {\n      node {\n        id\n        email\n        firstName\n        lastName\n        __typename\n      }\n      __typename\n    }\n    pageInfo {\n      ...PageInfoFragment\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"after": null, "first": 20, "query": "mi"}, "operationName": "SearchCustomers", "timesCalled": 2, "createdAt": "2021-09-04 19:19:54.611840+00:00", "updatedAt": "2021-09-04 20:28:56.151191+00:00"}
JSON;
