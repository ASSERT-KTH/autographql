...
class Q6289aa6f7f81594e94984e71bd7ba663Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "query Category($id: ID!) {\n  category(id: $id) {\n    seoDescription\n    seoTitle\n    id\n    name\n    backgroundImage {\n      url\n      __typename\n    }\n    ancestors(last: 5) {\n      edges {\n        node {\n          id\n          name\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n  attributes(filter: {inCategory: $id, filterableInStorefront: true}, first: 100) {\n    edges {\n      node {\n        id\n        name\n        slug\n        values {\n          id\n          name\n          slug\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"attributes": [{"slug": "material", "value": "polyester"}], "pageSize": 6, "priceGte": null, "priceLte": null, "sortBy": null, "id": "Q2F0ZWdvcnk6Nw=="}, "operationName": "Category", "timesCalled": 2, "createdAt": "2021-09-04 12:35:37.695405+00:00", "updatedAt": "2021-09-04 20:28:51.730271+00:00"}
JSON;
