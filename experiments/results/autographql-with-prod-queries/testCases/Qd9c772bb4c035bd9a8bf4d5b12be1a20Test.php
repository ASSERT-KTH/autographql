...
class Qd9c772bb4c035bd9a8bf4d5b12be1a20Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment PageInfoFragment on PageInfo {\n  endCursor\n  hasNextPage\n  hasPreviousPage\n  startCursor\n  __typename\n}\n\nquery SearchProducts($after: String, $first: Int!, $query: String!) {\n  search: products(after: $after, first: $first, filter: {search: $query}) {\n    edges {\n      node {\n        id\n        name\n        thumbnail {\n          url\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    pageInfo {\n      ...PageInfoFragment\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"after": "WyJ3aGl0ZS13aW5lIl0=", "first": 20, "query": ""}, "operationName": "SearchProducts", "timesCalled": 2, "createdAt": "2021-09-04 13:20:53.551082+00:00", "updatedAt": "2021-09-04 20:29:01.690876+00:00"}
JSON;
