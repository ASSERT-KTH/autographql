...
class Qe56b5d25c28856c1b957e3ad1a162c87Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment CustomerFragment on User {\n  id\n  email\n  firstName\n  lastName\n  __typename\n}\n\nquery ListCustomers($after: String, $before: String, $first: Int, $last: Int, $filter: CustomerFilterInput, $sort: UserSortingInput) {\n  customers(after: $after, before: $before, first: $first, last: $last, filter: $filter, sortBy: $sort) {\n    edges {\n      node {\n        ...CustomerFragment\n        orders {\n          totalCount\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"first": 20, "filter": {"dateJoined": null, "moneySpent": null, "numberOfOrders": null}, "sort": {"direction": "ASC", "field": "ORDER_COUNT"}}, "operationName": "ListCustomers", "timesCalled": 2, "createdAt": "2021-09-04 19:17:53.696431+00:00", "updatedAt": "2021-09-04 20:29:03.492388+00:00"}
JSON;
