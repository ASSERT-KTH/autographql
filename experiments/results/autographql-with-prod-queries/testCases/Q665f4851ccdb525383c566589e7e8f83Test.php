...
class Q665f4851ccdb525383c566589e7e8f83Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment CustomerFragment on User {\n  id\n  email\n  firstName\n  lastName\n  __typename\n}\n\nfragment AddressFragment on Address {\n  city\n  cityArea\n  companyName\n  country {\n    __typename\n    code\n    country\n  }\n  countryArea\n  firstName\n  id\n  lastName\n  phone\n  postalCode\n  streetAddress1\n  streetAddress2\n  __typename\n}\n\nfragment CustomerAddressesFragment on User {\n  ...CustomerFragment\n  addresses {\n    ...AddressFragment\n    __typename\n  }\n  defaultBillingAddress {\n    id\n    __typename\n  }\n  defaultShippingAddress {\n    id\n    __typename\n  }\n  __typename\n}\n\nquery CustomerAddresses($id: ID!) {\n  user(id: $id) {\n    ...CustomerAddressesFragment\n    __typename\n  }\n}\n", "variables": {"id": "VXNlcjoxMw=="}, "operationName": "CustomerAddresses", "timesCalled": 2, "createdAt": "2021-09-04 19:40:49.040998+00:00", "updatedAt": "2021-09-04 20:28:52.017774+00:00"}
JSON;
