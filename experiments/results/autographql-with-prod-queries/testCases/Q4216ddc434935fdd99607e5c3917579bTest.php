...
class Q4216ddc434935fdd99607e5c3917579bTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment PageInfoFragment on PageInfo {\n  endCursor\n  hasNextPage\n  hasPreviousPage\n  startCursor\n  __typename\n}\n\nquery SearchAvailableAttributes($id: ID!, $after: String, $first: Int!, $query: String!) {\n  productType(id: $id) {\n    id\n    availableAttributes(after: $after, first: $first, filter: {search: $query}) {\n      edges {\n        node {\n          id\n          name\n          slug\n          __typename\n        }\n        __typename\n      }\n      pageInfo {\n        ...PageInfoFragment\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"after": null, "first": 20, "query": "fun", "id": "UHJvZHVjdFR5cGU6MTY="}, "operationName": "SearchAvailableAttributes", "timesCalled": 2, "createdAt": "2021-09-04 13:26:04.832374+00:00", "updatedAt": "2021-09-04 20:28:49.339401+00:00"}
JSON;
