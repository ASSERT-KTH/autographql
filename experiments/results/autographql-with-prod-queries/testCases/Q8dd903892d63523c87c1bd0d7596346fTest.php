...
class Q8dd903892d63523c87c1bd0d7596346fTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment PageInfoFragment on PageInfo {\n  endCursor\n  hasNextPage\n  hasPreviousPage\n  startCursor\n  __typename\n}\n\nquery SearchProducts($after: String, $first: Int!, $query: String!) {\n  search: products(after: $after, first: $first, filter: {search: $query}) {\n    edges {\n      node {\n        id\n        name\n        thumbnail {\n          url\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    pageInfo {\n      ...PageInfoFragment\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"after": "WyJwaW5lYXBwbGUtanVpY2UiXQ==", "first": 20, "query": ""}, "operationName": "SearchProducts", "timesCalled": 4, "createdAt": "2021-09-04 13:20:49.284556+00:00", "updatedAt": "2021-09-04 20:28:55.947544+00:00"}
JSON;
