...
class Qca59b9ec2ef55a8f8effaf693b783a7aTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "query Collection($id: ID!) {\n  collection(id: $id) {\n    id\n    slug\n    name\n    seoDescription\n    seoTitle\n    backgroundImage {\n      url\n      __typename\n    }\n    __typename\n  }\n  attributes(filter: {inCollection: $id, filterableInStorefront: true}, first: 100) {\n    edges {\n      node {\n        id\n        name\n        slug\n        values {\n          id\n          name\n          slug\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"attributes": [{"slug": "bottle-size", "value": "500ml"}], "pageSize": 6, "priceGte": null, "priceLte": null, "sortBy": null, "id": "Q29sbGVjdGlvbjox"}, "operationName": "Collection", "timesCalled": 2, "createdAt": "2021-09-04 12:35:58.678694+00:00", "updatedAt": "2021-09-04 20:29:00.548973+00:00"}
JSON;
