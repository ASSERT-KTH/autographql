...
class Q0c825545f4af55e5a3a161baf455859cTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "query Collection($id: ID!) {\n  collection(id: $id) {\n    id\n    slug\n    name\n    seoDescription\n    seoTitle\n    backgroundImage {\n      url\n      __typename\n    }\n    __typename\n  }\n  attributes(filter: {inCollection: $id, filterableInStorefront: true}, first: 100) {\n    edges {\n      node {\n        id\n        name\n        slug\n        values {\n          id\n          name\n          slug\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"attributes": {}, "pageSize": 6, "priceGte": null, "priceLte": null, "sortBy": null, "id": "Q29sbGVjdGlvbjox"}, "operationName": "Collection", "timesCalled": 3, "createdAt": "2021-09-04 12:35:50.960972+00:00", "updatedAt": "2021-09-05 13:53:04.629775+00:00"}
JSON;
