...
class Q808340c62efb599e913ec96cb189f701Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment WebhookFragment on Webhook {\n  id\n  name\n  isActive\n  app {\n    id\n    name\n    __typename\n  }\n  __typename\n}\n\nquery WebhookDetails($id: ID!) {\n  webhook(id: $id) {\n    ...WebhookFragment\n    events {\n      eventType\n      __typename\n    }\n    secretKey\n    targetUrl\n    __typename\n  }\n}\n", "variables": {"id": "V2ViaG9vazoy"}, "operationName": "WebhookDetails", "timesCalled": 4, "createdAt": "2021-09-04 13:35:33.847682+00:00", "updatedAt": "2021-09-04 20:28:54.837210+00:00"}
JSON;
