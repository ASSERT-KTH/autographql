...
class Q99a5b025362d572b93c2c30cfc01d31cTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment PageInfoFragment on PageInfo {\n  endCursor\n  hasNextPage\n  hasPreviousPage\n  startCursor\n  __typename\n}\n\nquery SearchAvailableAttributes($id: ID!, $after: String, $first: Int!, $query: String!) {\n  productType(id: $id) {\n    id\n    availableAttributes(after: $after, first: $first, filter: {search: $query}) {\n      edges {\n        node {\n          id\n          name\n          slug\n          __typename\n        }\n        __typename\n      }\n      pageInfo {\n        ...PageInfoFragment\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"after": null, "first": 20, "query": "w", "id": "UHJvZHVjdFR5cGU6MTY="}, "operationName": "SearchAvailableAttributes", "timesCalled": 4, "createdAt": "2021-09-04 19:51:10.168012+00:00", "updatedAt": "2021-09-04 20:28:56.655330+00:00"}
JSON;
