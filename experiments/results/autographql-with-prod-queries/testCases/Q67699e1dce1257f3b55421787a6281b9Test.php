...
class Q67699e1dce1257f3b55421787a6281b9Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "query SearchResults($query: String!) {\n  products(filter: {search: $query}, first: 20) {\n    edges {\n      node {\n        id\n        name\n        thumbnail {\n          url\n          alt\n          __typename\n        }\n        thumbnail2x: thumbnail(size: 510) {\n          url\n          __typename\n        }\n        category {\n          id\n          name\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"query": "12"}, "operationName": "SearchResults", "timesCalled": 1, "createdAt": "2021-09-05 13:55:40.633702+00:00", "updatedAt": "2021-09-05 13:55:40.633719+00:00"}
JSON;
