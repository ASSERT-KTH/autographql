...
class Qa639c103472c5322b40f395963315cb8Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment BasicProductFields on Product {\n  id\n  name\n  thumbnail {\n    url\n    alt\n    __typename\n  }\n  thumbnail2x: thumbnail(size: 510) {\n    url\n    __typename\n  }\n  __typename\n}\n\nfragment Price on TaxedMoney {\n  gross {\n    amount\n    currency\n    __typename\n  }\n  net {\n    amount\n    currency\n    __typename\n  }\n  __typename\n}\n\nfragment ProductPricingField on Product {\n  pricing {\n    onSale\n    priceRangeUndiscounted {\n      start {\n        ...Price\n        __typename\n      }\n      stop {\n        ...Price\n        __typename\n      }\n      __typename\n    }\n    priceRange {\n      start {\n        ...Price\n        __typename\n      }\n      stop {\n        ...Price\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n  __typename\n}\n\nquery CategoryProducts($id: ID!, $attributes: [AttributeInput], $after: String, $pageSize: Int, $sortBy: ProductOrder, $priceLte: Float, $priceGte: Float) {\n  products(after: $after, first: $pageSize, sortBy: $sortBy, filter: {attributes: $attributes, categories: [$id], minimalPrice: {gte: $priceGte, lte: $priceLte}}) {\n    totalCount\n    edges {\n      node {\n        ...BasicProductFields\n        ...ProductPricingField\n        category {\n          id\n          name\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"attributes": [{"slug": "size", "value": "xl"}], "pageSize": 6, "priceGte": null, "priceLte": null, "sortBy": {"field": "DATE", "direction": "DESC"}, "id": "Q2F0ZWdvcnk6OQ==", "after": "WyIyMDIxLTA5LTAzIDE2OjI3OjEwLjYwMTk3MCswMDowMCIsICJULXNoaXJ0IiwgInQtc2hpcnQtMiJd"}, "operationName": "CategoryProducts", "timesCalled": 1, "createdAt": "2021-09-05 13:54:14.113751+00:00", "updatedAt": "2021-09-05 13:54:14.113763+00:00"}
JSON;
