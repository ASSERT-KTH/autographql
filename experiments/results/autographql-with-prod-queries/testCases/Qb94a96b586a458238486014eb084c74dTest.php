...
class Qb94a96b586a458238486014eb084c74dTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment AddressFragment on Address {\n  city\n  cityArea\n  companyName\n  country {\n    __typename\n    code\n    country\n  }\n  countryArea\n  firstName\n  id\n  lastName\n  phone\n  postalCode\n  streetAddress1\n  streetAddress2\n  __typename\n}\n\nfragment WarehouseFragment on Warehouse {\n  id\n  name\n  __typename\n}\n\nfragment WarehouseWithShippingFragment on Warehouse {\n  ...WarehouseFragment\n  shippingZones(first: 100) {\n    edges {\n      node {\n        id\n        name\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n  __typename\n}\n\nfragment WarehouseDetailsFragment on Warehouse {\n  ...WarehouseWithShippingFragment\n  address {\n    ...AddressFragment\n    __typename\n  }\n  __typename\n}\n\nquery WarehouseDetails($id: ID!) {\n  warehouse(id: $id) {\n    ...WarehouseDetailsFragment\n    __typename\n  }\n}\n", "variables": {"id": "V2FyZWhvdXNlOjkwMjNlNjEwLWU4MWYtNDI2OS1iNzNiLTM3NTE2ZmMxYjgyZQ=="}, "operationName": "WarehouseDetails", "timesCalled": 2, "createdAt": "2021-09-04 19:41:31.308511+00:00", "updatedAt": "2021-09-04 20:28:59.578945+00:00"}
JSON;
