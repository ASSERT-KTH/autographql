...
class Qb821f2e0976d5117878c2d3c4f8bc34fTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment PageInfoFragment on PageInfo {\n  endCursor\n  hasNextPage\n  hasPreviousPage\n  startCursor\n  __typename\n}\n\nquery SearchCategories($after: String, $first: Int!, $query: String!) {\n  search: categories(after: $after, first: $first, filter: {search: $query}) {\n    edges {\n      node {\n        id\n        name\n        __typename\n      }\n      __typename\n    }\n    pageInfo {\n      ...PageInfoFragment\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"after": null, "first": 20, "query": "styy"}, "operationName": "SearchCategories", "timesCalled": 2, "createdAt": "2021-09-04 19:16:36.043624+00:00", "updatedAt": "2021-09-04 20:28:59.368126+00:00"}
JSON;
