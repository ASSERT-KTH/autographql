...
class Qcceb7a758284573288dbe4c6b0c98bdaTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "query SearchResults($query: String!) {\n  products(filter: {search: $query}, first: 20) {\n    edges {\n      node {\n        id\n        name\n        thumbnail {\n          url\n          alt\n          __typename\n        }\n        thumbnail2x: thumbnail(size: 510) {\n          url\n          __typename\n        }\n        category {\n          id\n          name\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"query": "polo"}, "operationName": "SearchResults", "timesCalled": 2, "createdAt": "2021-09-04 20:12:06.321551+00:00", "updatedAt": "2021-09-04 20:29:00.693724+00:00"}
JSON;
