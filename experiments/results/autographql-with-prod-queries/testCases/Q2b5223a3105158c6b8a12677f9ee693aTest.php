...
class Q2b5223a3105158c6b8a12677f9ee693aTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "query AppsList($before: String, $after: String, $first: Int, $last: Int, $sort: AppSortingInput, $filter: AppFilterInput) {\n  apps(before: $before, after: $after, first: $first, last: $last, sortBy: $sort, filter: $filter) {\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n      __typename\n    }\n    totalCount\n    edges {\n      node {\n        id\n        name\n        isActive\n        type\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"first": 30, "sort": {"direction": "DESC", "field": "CREATION_DATE"}, "filter": {"type": "THIRDPARTY"}}, "operationName": "AppsList", "timesCalled": 2, "createdAt": "2021-09-04 13:30:34.047629+00:00", "updatedAt": "2021-09-04 20:28:47.543737+00:00"}
JSON;
