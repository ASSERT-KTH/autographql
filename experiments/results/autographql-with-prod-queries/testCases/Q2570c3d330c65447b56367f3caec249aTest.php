...
class Q2570c3d330c65447b56367f3caec249aTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "query SearchOrderVariant($first: Int!, $query: String!, $after: String) {\n  search: products(first: $first, after: $after, filter: {search: $query}) {\n    edges {\n      node {\n        id\n        name\n        thumbnail {\n          url\n          __typename\n        }\n        variants {\n          id\n          name\n          sku\n          pricing {\n            priceUndiscounted {\n              net {\n                amount\n                currency\n                __typename\n              }\n              __typename\n            }\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"after": null, "first": 20, "query": "w"}, "operationName": "SearchOrderVariant", "timesCalled": 2, "createdAt": "2021-09-04 12:52:07.617497+00:00", "updatedAt": "2021-09-04 20:28:47.146622+00:00"}
JSON;
