...
class Q235c6a623d79583d90b8ede0babd0fb5Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "fragment CategoryTranslationFragment on Category {\n  id\n  name\n  descriptionJson\n  seoDescription\n  seoTitle\n  translation(languageCode: $language) {\n    id\n    descriptionJson\n    language {\n      language\n      __typename\n    }\n    name\n    seoDescription\n    seoTitle\n    __typename\n  }\n  __typename\n}\n\nquery CategoryTranslationDetails($id: ID!, $language: LanguageCodeEnum!) {\n  category(id: $id) {\n    ...CategoryTranslationFragment\n    __typename\n  }\n}\n", "variables": {"id": "Q2F0ZWdvcnk6MTQ=", "language": "HI"}, "operationName": "CategoryTranslationDetails", "timesCalled": 2, "createdAt": "2021-09-04 13:38:28.657166+00:00", "updatedAt": "2021-09-04 20:28:46.931189+00:00"}
JSON;
